...
$(function() {
    ...
    storeHeightSquareFront();
    storeHeightSquareBack();
    ...
    $("#max-size-square-front").click(function() {
        ...
        $("#square-pillow-front-height-rep").css("height", $('#print-square-front').height());
    });
    ...
    $("#max-size-square-back").click(function() {
        ...
        centerImgSquareBack();
        $("#square-pillow-back-height-rep").css("height", $('#print-square-back').height());
    });
...
var storeHeightSquareBack = function() {
    $('#print-square-back').load(function() {
        $("#square-pillow-back-height-rep").css("height", $('#print-square-back').height());
    });
};

var storeHeightSquareFront = function() {
...
$('#download-square-front').click(function(e) {
    ...
    if ($.trim($("#print-square-front").attr("src")) !== "" || $.trim($("#print-square-back").attr("src")) !== "") {
        ...
        ctx.drawImage(pillow_backing, 0, $('#printer_square_front').height() - 2);
        if ($.trim($("#print-square-back").attr("src")) !== "") {
            console.log("got a back print too!");
            console.log(poster_back);
            console.log(positionYback);
            console.log(back_print_width);
            console.log(back_print_height);
            ctx.drawImage(poster_back, positionXback, positionYback, back_print_width, back_print_height);
        }
        ctx.drawImage(mask, 0, $('#printer_square_front').height() - 2);

        if (c.msToBlob) { //for IE
            var blob = c.msToBlob();
            saveAs(blob, "pillow-square-front.png");
...
$('#download-square-back').click(function(e) {
    ...
    if ($.trim($("#print-square-back").attr("src")) !== "" || $.trim($("#print-square-front").attr("src")) !== "") {
        ...
        ctx.drawImage(pillow_backing, 0, 0);
        if ($.trim($("#print-square-front").attr("src")) !== "") {
            console.log("got a front print too!");
            console.log(poster_front);
            console.log(positionY);
            console.log(front_print_width);
            console.log(front_print_height);
            ctx.drawImage(poster_front, positionX, positionY, front_print_width, front_print_height);
        }
        ctx.drawImage(mask, 0, 0);
