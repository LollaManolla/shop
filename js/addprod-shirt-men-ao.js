...
$(function() {
    ...
    $("#printer_front_men").width(containerWidthProp);
    $("#printer_front_men").height(containerHeightProp);
    $("#printer_front_men").css("margin-left", -(containerWidthProp/2)+ "px");

    $("#printer_back_men").width(containerWidthProp);
    $("#printer_back_men").height(containerHeightProp);
    $("#printer_back_men").css("margin-left", -(containerWidthProp/2)+ "px");

    $("#reg-print").prop('checked', true);
    $("#ao-print").prop('checked', false);
...
//-------switch between all-over and regular design templates-------//
  $("input[name=gender]").on( "change", function() {
    ...
    if (gender_type == "men") {
      $("#shirt-icons-men").show();
      $("#shirt-icons-women").hide();
      ...
      $("#shirt-icons-men").hide();
      $("#shirt-icons-women").show();
        ...
        if (extn == "png" || extn == "jpg" || extn == "jpeg") {
            if (typeof(FileReader) != "undefined") {
                ...
                for (var i = 0; i < countFiles; i++) {
                    ...
                    $('#men-bg-front').hide();
                    $('#shirt-men-printarea-front').show();
...
$('#download-shirt-men-front').click(function(e) {
  ...
  if ($.trim($("#print-men-front").attr("src")) != "" || $.trim($("#print-men-back").attr("src")) != "") {
      ...
      if ($.trim($("#print-men-front").attr("src")) != "") {
        ...
        var positionX = $('#printer_front_men > .ui-wrapper').position().left;
        var positionY = $('#printer_front_men > .ui-wrapper').position().top;
        var poster_front = document.getElementById("print-men-front");
      }

      var positionXback = parseInt($('#print-men-back').parent().css("left"));
      var positionYback = parseInt($('#print-men-back').parent().css("top"));
      ...
      c.width = $('#printer_front_men').width();
      c.height = $('#printer_front_men').height();
      ctx = c.getContext("2d");
      ctx.fillStyle = color;

      ctx.fillRect(0, 0, $('#printer_front_men').width(), $('#printer_front_men').height());

      var shirt_bg_img_front = document.getElementById("allover-shirt-men-front-backing");
      var shirt_bg_img_back = document.getElementById("allover-shirt-men-back-backing");
      var shirt_mask_front = document.getElementById("allover-shirt-men-front-mask");
      var shirt_mask_back = document.getElementById("allover-shirt-men-back-mask");
      ...
      c2.width = $('#printer_front_men').width();
      c2.height = $('#printer_front_men').height();
      ctx2 = c2.getContext("2d");
      ctx2.fillStyle = color;
      ctx2.fillRect(0, 0, $('#printer_front_men').width(), $('#printer_front_men').height());
      ...
      c3.width = $('#printer_front_men').width() * 2 + 90;
      c3.height = $('#printer_front_men').height() + 60;
      ctx3 = c3.getContext("2d");
      ctx3.fillStyle = "#fff";
      ctx3.fillRect(0, 0, c3.width, c3.height);
      ctx3.drawImage(c, 40, 30);
      ctx3.drawImage(c2, parseInt($('#printer_front_men').width()) + 50, 30);
...
$('#download-shirt-men-back').click(function(e) {
  ...
  /********** create image for men pillow back ***********/
  if ($.trim($("#print-men-back").attr("src")) != "" || $.trim($("#print-men-front").attr("src")) != "") {
      ...
      var positionX = parseInt($('#print-men-front').parent().css("left"));
      var positionY = parseInt($('#print-men-front').parent().css("top"));

      if ($.trim($("#print-men-back").attr("src")) != "") {
        var back_print_width = $('#print-men-back').width();
        var back_print_height = $('#print-men-back').height();
        var positionXback =  ($('#printer_back_men > .ui-wrapper').position().left);
        var positionYback = ($('#printer_back_men > .ui-wrapper').position().top);
      }
...
var removeShirtArt_front_men = function() {
  ...
  $('#art-input-men-front').val('');
  $('#men-bg-front').show();
  $('#shirt-men-printarea-front').hide();
