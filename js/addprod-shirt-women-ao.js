...
var containerProportionW = 10;
/* Print container area height inch for shirt */
var containerHeightInchW = 32;
/* Print container area width inch for shirt */
var containerWidthInchW = 36;
/* Print container area height px */
var containerWidthPxW = containerWidthInchW * dpi;
/* Print container area height px */
var containerHeightPxW = containerHeightInchW * dpi;
...
$(function() {
    ...
    $("#printer_front_women").width(containerWidthPropW);
    $("#printer_front_women").height(containerHeightPropW);
    $("#printer_front_women").css("margin-left", -(containerWidthPropW/2)+ "px");

    $("#printer_back_women").width(containerWidthPropW);
    $("#printer_back_women").height(containerHeightPropW);
    $("#printer_back_women").css("margin-left", -(containerWidthPropW/2)+ "px");
        ...
        if (extn == "png" || extn == "jpg" || extn == "jpeg") {
            if (typeof(FileReader) != "undefined") {
                ...
                for (var i = 0; i < countFiles; i++) {
                    ...
                    $('#women-bg-front').hide();
                    $('#shirt-women-printarea-front').show();
        ...
        if (extn == "png" || extn == "jpg" || extn == "jpeg") {
            if (typeof(FileReader) != "undefined") {
                ...
                for (var i = 0; i < countFiles; i++) {
                    ...
                    $('#women-bg-back').hide();
                    $('#shirt-women-printarea-back').show();
...
$('#download-shirt-women-front').click(function(e) {
  ...
  if ($.trim($("#print-women-front").attr("src")) != "" || $.trim($("#print-women-back").attr("src")) != "") {
      ...
      if ($.trim($("#print-women-front").attr("src")) != "") {
        ...
        var positionX = $('#printer_front_women > .ui-wrapper').position().left;
        var positionY = $('#printer_front_women > .ui-wrapper').position().top;
        var poster_front = document.getElementById("print-women-front");
      }

      var positionXback = parseInt($('#print-women-back').parent().css("left"));
      var positionYback = parseInt($('#print-women-back').parent().css("top"));
      ...
      c.width = $('#printer_front_women').width();
      c.height = $('#printer_front_women').height();
      ctx = c.getContext("2d");
      ctx.fillStyle = color;

      ctx.fillRect(0, 0, $('#printer_front_women').width(), $('#printer_front_women').height());

      var shirt_bg_img_front = document.getElementById("allover-shirt-women-front-backing");
      var shirt_bg_img_back = document.getElementById("allover-shirt-women-back-backing");
      var shirt_mask_front = document.getElementById("allover-shirt-women-front-mask");
      var shirt_mask_back = document.getElementById("allover-shirt-women-back-mask");

      var poster_front = document.getElementById("print-women-front");
      var poster_back = document.getElementById("print-women-back");


      ctx.drawImage(shirt_bg_img_front, 0, 0);
      if ($.trim($("#print-women-front").attr("src")) !== "") {
          ctx.drawImage(poster_front, positionX, positionY, front_print_width, front_print_height);
      }
      ctx.drawImage(shirt_mask_front, 0, 0);

      c2 = document.getElementById("cloner_back");
      c2.width = $('#printer_front_women').width();
      c2.height = $('#printer_front_women').height();
      ctx2 = c2.getContext("2d");
      ctx2.fillStyle = color;
      ctx2.fillRect(0, 0, $('#printer_front_women').width(), $('#printer_front_women').height());

      ctx2.drawImage(shirt_bg_img_back, 0, 0);
      ...
      ctx2.drawImage(shirt_mask_back, 0, 0);

      c3 = document.getElementById("cloner_final");
      c3.width = $('#printer_front_women').width() * 2 + 90;
      c3.height = $('#printer_front_women').height() + 60;
      ctx3 = c3.getContext("2d");
      ctx3.fillStyle = "#fff";
      ctx3.fillRect(0, 0, c3.width, c3.height);
      ctx3.drawImage(c, 40, 30);
      ctx3.drawImage(c2, parseInt($('#printer_front_women').width()) + 50, 30);

      if (c3.msToBlob) { //for IE
          var blob = c3.msToBlob();
          saveAs(blob, "LA-Apparel-shirt-design-all-over.png");
...
$('#download-shirt-women-back').click(function(e) {
  ...
  /********** create image for women pillow back ***********/
  if ($.trim($("#print-women-back").attr("src")) != "" || $.trim($("#print-women-front").attr("src")) != "") {
      ...
      var positionX = parseInt($('#print-women-front').parent().css("left"));
      var positionY = parseInt($('#print-women-front').parent().css("top"));

      if ($.trim($("#print-women-back").attr("src")) != "") {
        var back_print_width = $('#print-women-back').width();
        var back_print_height = $('#print-women-back').height();
        var positionXback =  ($('#printer_back_women > .ui-wrapper').position().left);
        var positionYback = ($('#printer_back_women > .ui-wrapper').position().top);
      }
...
var removeShirtArt_front_women = function() {
  ...
  $('#art-input-women-front').val('');
  $('#women-bg-front').show();
  $('#shirt-women-printarea-front').hide();
...
var removeShirtArt_back_women = function() {
  ...
  $('#art-input-women-back').val('');
  $('#women-bg-back').show();
  $('#shirt-women-printarea-back').hide();
...
var switch_front_back_women = function(e) {
  ...
  if ($(e).hasClass("shirt-front")) {
    ...
    $("#shirt-icons-women .shirt-front").removeClass("active");
    $("#shirt-icons-women .shirt-back").addClass("active");
